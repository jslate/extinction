...
<p><strong>Visit:</strong> The <a href="http://phaser.io">Phaser website</a> and follow on <a href="https://twitter.com/photonstorm">Twitter</a> (#phaserjs)<br />
<strong>Learn:</strong> <a href="http://phaser.io/docs">API Docs</a>, <a href="http://www.html5gamedevs.com/forum/14-phaser/">Support Forum</a> and <a href="http://stackoverflow.com/questions/tagged/phaser-framework">StackOverflow</a><br />
<strong>Code:</strong> 700+ <a href="http://phaser.io/examples">Examples</a> (source available in this <a href="https://github.com/photonstorm/phaser-examples">repo</a>)<br />
<strong>Read:</strong> Weekly <a href="#newsletter">Phaser World</a> Newsletter<br />
<strong>Chat:</strong> <a href="http://phaser.io/community/slack">Slack</a> and <a href="http://phaser.io/community/irc">IRC</a><br />
<strong>Extend:</strong> With <a href="http://phaser.io/shop/plugins">Phaser Plugins</a><br />
...
<p><a name="whats-new"></a>
<img src="http://phaser.io/images/github/div-whats-new.png" alt="What's New" title="What's New"></p>
<div align="center"><img src="http://phaser.io/images/github/news.jpg"></div>

<blockquote>
<p>11th July 2016</p>
</blockquote>
<p>Welcome to Phaser 2.6.1. Our eighth release this year, and another leap forwards since 2.5.0 less than a month ago. This version includes the work undertaken with adding circular body support into Arcade Physics, allowing you to now define physics bodies as being circles instead of rectangles, something that was previously only available in P2 Physics.</p>
<p>Keeping with Arcade Physics for a moment there are now new events you can listen for, including Body.onWorldBounds, Body.onCollide and Body.onOverlap. Phaser.Groups have also been given a shot in the arm. You can now position them, and all of their children, using the new bounds commands such as left, centerX and bottom. They've also gained the alignTo and alignIn methods from the 2.5 release.</p>
<p>In this release we've undertaken a large amount of work refactoring Pixi. You will find lots of Pixi related methods, that were redundant, removed from the build (such as fromImage). All references to the Pixi Texture and Base Texture caches have also been removed, helping close-off some straggling issues, and free-up lingering resources. Please see the Pixi section of the Change Log for complete details. This will not effect you if you're just using Phaser, but if you had any Pixi specific mods or plugins, they may need checking over.</p>
<p>I've also been working hard on the documentation. Tidying-up functions that didn't have parameter descriptions, adding lots more details to areas such as the Game Object events, and starting the huge task of rewriting all of the Pixi documentation into a more friendly and comprehensive format. This is an on-going task, and will be merged into releases from here-on.</p>
<p>Check the <a href="#change-log">Change Log</a> to see the complete list of what's new in this release.</p>
...
<p><a name="support"></a>
<img src="http://phaser.io/images/github/div-support-phaser.png" alt="Support Phaser" title="Support Phaser"></p>
...
<p><img src="http://phaser.io/images/github/div-newsletter.png" alt="Weekly Newsletter" title="Weekly Newsletter">
...
<p><img src="http://phaser.io/images/github/div-download.png" alt="Download Phaser" title="Download Phaser">
<a name="download"></a></p>
...
<li>Download as <a href="https://github.com/photonstorm/phaser/archive/v2.6.1.zip">zip</a> or <a href="https://github.com/photonstorm/phaser/archive/v2.6.1.tar.gz">tar.gz</a></li>
<li>Download just the build files: <a href="https://github.com/photonstorm/phaser/releases/download/v2.6.1/phaser.js">phaser.js</a> and <a href="https://github.com/photonstorm/phaser/releases/download/v2.6.1/phaser.min.js">phaser.min.js</a></li>
...
<p><code>&lt;script src=&quot;//cdn.jsdelivr.net/phaser/2.6.1/phaser.js&quot;&gt;&lt;/script&gt;</code></p>
<p>or the minified version:</p>
<p><code>&lt;script src=&quot;//cdn.jsdelivr.net/phaser/2.6.1/phaser.min.js&quot;&gt;&lt;/script&gt;</code></p>
...
<p><code>&lt;script src=&quot;https://cdnjs.cloudflare.com/ajax/libs/phaser/2.6.1/phaser.js&quot;&gt;&lt;/script&gt;</code></p>
...
<p><img src="http://phaser.io/images/github/div-getting-started.png" alt="Getting Started" title="Getting Started">
...
<p><img src="http://phaser.io/images/github/div-building-phaser.png" alt="Building Phaser" title="Building Phaser">
<a name="building-phaser"></a></p>
...
<p><img src="http://phaser.io/images/github/div-made-with.png" alt="Made With Phaser" title="Made With Phaser">
<a name="games"></a></p>
...
<p><img src="http://phaser.io/images/github/div-requirements.png" alt="Requirements" title="Requirements">
...
<p><img src="http://phaser.io/images/github/div-roadmap.png" alt="Road Map" title="Road Map">
<a name="road-map"></a></p>
...
<p><img src="http://phaser.io/images/github/div-change-log.png" alt="Change Log" title="Change Log">
<a name="change-log"></a></p>
<h2>Version 2.6.1 - &quot;Caemlyn&quot; - 11th July 2016</h2><h3>Bug Fixes</h3><ul>
<li>Fixed <code>Uncaught TypeError: Cannot set property 'x' of undefined</code> in Body.js (thanks @ErwanErwan #2607)</li>
</ul>
<h2>Version 2.6.0 - &quot;Fal Moran&quot; - 8th July 2016</h2><h3>New Features</h3><ul>
<li>The Loader has a new property <code>headers</code>. This is an object checked by XHR Requests, used to set the Request Header of certain file types. JSON and XML are pre-configured, but you can add to, or modify this property as required (thanks @stoneman1 #2585 #2485)</li>
<li>Phaser now has support for Typings, the TypeScript Definition Manager. See the <code>typescript/readme.md</code> file for installation instructions (thanks @monagames #2576)</li>
<li>Phaser.Utils.reverseString will take the given string, reverse it, and then return it.</li>
<li>Phaser.ArrayUtils.rotateRight is the opposite of ArrayUtils.rotate. It takes an array, removes the element from the end of the array, and inserts it at the start, shifting everything else 1 space in the process.</li>
<li>Phaser.ArrayUtils.rotateLeft is the new name for Phaser.ArrayUtils.rotate. The old method is now deprecated (but still available in this release)</li>
<li>Phaser.Color.toABGR converts RGBA components to a 32 bit integer in AABBGGRR format.</li>
<li>ArcadePhysics.Body.setCircle is a new method that allows you to define an Arcade Physics Body as being a circle instead of a rectangle. You can control the radius of the body and the offset from the parent sprite.</li>
<li>ArcadePhysics.World.separateCircle is a new method that handles all circular body collisions internally within Arcade Physics (thanks @VitaZheltyakov)</li>
<li>All of the Arcade Physics internal methods, such as <code>collideGroupVsSelf</code>, <code>collideSpriteVsSprite</code> and so on, have been updated to work with circular body shapes (thanks @VitaZheltyakov)</li>
<li>ArcadePhysics.Body.onWorldBounds is a new Signal that is dispatched whenever the Body collides with the world bounds, something that was previously difficult to detect. Due to the potentially high volume of signals this could create it is disabled by default. To use this feature set this property to a Phaser.Signal: <code>sprite.body.onWorldBounds = new Phaser.Signal()</code> and it will be called when a collision happens, passing five arguments: the sprite on which it occurred, and 4 booleans mapping to up, down, left and right, indicating on which side of the world the collision occurred.</li>
<li>ArcadePhysics.Body.onCollide is a new Signal that is dispatched whenever the Body collides with another Body. Due to the potentially high volume of signals this could create it is disabled by default. To use this feature set this property to a Phaser.Signal: <code>sprite.body.onCollide = new Phaser.Signal()</code> and it will be called when a collision happens, passing two arguments: the sprites which collided.</li>
<li>ArcadePhysics.Body.onOverlap is a new Signal that is dispatched whenever the Body overlaps with another Body. Due to the potentially high volume of signals this could create it is disabled by default. To use this feature set this property to a Phaser.Signal: <code>sprite.body.onOverlap = new Phaser.Signal()</code> and it will be called when an overlap happens, passing two arguments: the sprites which collided.</li>
<li>Groups now have the following properties, which are getters and setters: <code>centerX</code>, <code>centerY</code>, <code>left</code>, <code>right</code>, <code>top</code> and <code>bottom</code>. These calculate the bounds of the Group, based on all visible children, and then allow you to apply positioning based on that. This means you can, for example, now get the horizontal center of a Group by called <code>Group.centerX</code>. These properties are also setters, so you can position the Groups, and it will take scale and rotation into consideration.</li>
<li>Groups have a new method <code>alignIn</code>. It allows you to align the Group within another Game Object, or a Rectangle. You can specify one of 9 positions which are the new position constants such as: <code>Phaser.TOP_LEFT</code> or <code>Phaser.CENTER</code> (see docs for the complete list). The Groups are positioned based on their child bounds, which takes rotation and scaling into consideration. You can easily place Groups into the corners of the screen, or game world, or align them within other Sprites, using this method.</li>
<li>Groups have a new method <code>alignTo</code>. It allows you to align a Group to the side of another Game Object, or a Rectangle. You can specify one of 11 positions which are the new position constants such as: <code>Phaser.TOP_LEFT</code> or <code>Phaser.LEFT_BOTTOM</code> (see docs for the complete list). The Groups are positioned based on their child bounds, which takes rotation and scaling into consideration. You can easily align Groups next to other Sprites using this method.</li>
</ul>
<h3>Updates</h3><ul>
<li>TypeScript definitions fixes and updates (thanks @monagames)</li>
<li>Docs typo fixes (thanks @drhayes)</li>
<li>The TilemapParser will now add more data when importing Image object types from Tiled. The extra data available is: image width, image height, and flags to see if the image is flipped either horizontally, vertically or diagonally (thanks @gotenxds #2564 #2554)</li>
<li>TilemapLayer.renderRegion has had an assignment to the obsolete <code>tileColor</code> property removed (thanks @cryptographer #2583)</li>
<li>Group.getFurthestFrom and Group.getClosestTo has a new optional argument: <code>callback</code>. This allows you to apply your own additional filtering to the distance checks, ultimately influencing the selected child (thanks @LoneStranger #2577)</li>
<li>Text.setText has a new optional argument <code>immediate</code> which will re-create the texture immediately upon call, rather than wait for the next render pass to do so (thanks @Scraft #2594)</li>
<li>Phaser.Utils.pad now calls <code>toString</code> on the input given, which means you can pass in common data types, such as numbers, and have them padded and returned as strings.</li>
<li>The canvas created by Phaser.Debug for use when displaying debug data is no longer stored in the CanvasPool, and is instead a stand-alone canvas, free from ever being re-used by another game object.</li>
<li>BitmapData has a new, optional, fifth argument: <code>skipPool</code>. By default BitmapData objects will ask for the first free canvas found in the CanvasPool, but this behavior can now be customized on a per object basis.</li>
<li>Phaser.ArrayUtils.rotate is now deprecated. Please use Phaser.ArrayUtils.rotateLeft instead.</li>
<li>Phaser.Text.fontPropertiesCanvas used to be taken from the CanvasPool, but as it's constantly needed it is now generated directly from the document.</li>
<li>The default image texture, for when none is supplied, is now available under <code>Phaser.Cache.DEFAULT</code>.</li>
<li>The missing image texture, for when an image has failed to load, is now available under <code>Phaser.Cache.MISSING</code>.</li>
<li>Phaser.Cache.addImage will now check the key given, and if <code>__default</code> or <code>__missing</code> it will update the new consts <code>Phaser.Cache.DEFAULT</code> and <code>Phaser.Cache.MISSING</code> accordingly, allowing you to replace the default or missing image textures used by Phaser.</li>
<li>Phaser.Cache.getPixiTexture has now been removed, as the Pixi Cache isn't used internally anywhere any longer.</li>
<li>Phaser.Cache.getPixiBaseTexture has now been removed, as the Pixi Cache isn't used internally anywhere any longer.</li>
<li>The second argument to Phaser.Cache.removeImage has been renamed from <code>removeFromPixi</code> to <code>destroyBaseTexture</code>, as that is fundamentally what the argument always did.</li>
<li>AnimationManager.refreshFrame has been removed as it never actually did anything internally.</li>
<li>Sound.stop will check to see if <code>gainNode</code> exists before trying to disconnect from it (#2597)</li>
</ul>
<h3>Bug Fixes</h3><ul>
<li>Fixed issue in Group.align where the cell wouldn't increase if <code>rows</code> was great than -1</li>
<li>Sound.volume was accidentally repeated twice in the source (thanks @LoneStranger #2569)</li>
<li>Animation.setFrame wouldn't work correctly if the <code>useLocalFrameIndex</code> argument was true, and the frame ID was a number (thanks @uboot #2571)</li>
<li>Polygon.contains would only work with non-flattened Polygon objects. It now works with both flat and non-flat Polygons.</li>
<li>Graphics objects enabled for input would fail to do anything if a Phaser Polygon was given to the Graphics object (which it was in nearly all cases), as it wouldn't detect input correctly with flattened polygons (thanks @symbiane #2591)</li>
<li>P2.World.clear will now clear out the World.walls property, resetting all of the wall bounds to <code>null</code>. This allows the walls to be re-created accurately when the P2 World is reset, which happens on a State change or restart (thanks @ewpolly1 @codermua #2574)</li>
</ul>
...
<ul>
<li>Removed <code>_renderWebGL</code>, <code>_renderCanvas</code>, <code>getLocalBounds</code> and <code>getBounds</code> from PIXI.DisplayObject, as they were only there to pass ancient jshint rules.</li>
<li>All Pixi.Graphics methods that change the Graphics, i.e. <code>drawShape</code>, <code>lineTo</code>, <code>arc</code>, etc will now all automatically call <code>Graphics.updateLocalBounds</code>. This is so that the bounds of the Graphics object are kept updated, allowing you to scale and rotate the Graphics object and still obtain correct dimensions from it (thanks @kelu-smiley #2573)</li>
<li>PIXI.CanvasPool no longer <em>just</em> checks for <code>null</code> parent comparisons. It will check for all falsey parents, helping free-up canvases when the parent objects have been removed elsewhere.</li>
<li>PIXI.CanvasPool.remove and <code>removeByCanvas</code> both now set the removed canvas width and height to 1.</li>
<li>PIXI.Texture.fromImage, PIXI.BaseTexture.fromImage and PIXI.Sprite.fromImage have all been removed. They should never have actually been used, as they bypass the Phaser Loader, and don't factor in CORs or any other advanced loader settings.</li>
<li>The PIXI.BaseTexture.imageUrl property has been removed, as it was never actually populated.</li>
<li>The PIXI.BaseTexture._UID property has been removed, as it was never actually used internally.</li>
<li>All references to PIXI.BaseTextureCache have been removed (primarily from BaseTexture.destroy and Texture.destroy), as the BaseTextureCache was never used internally by Phaser, or by our custom version of Pixi.</li>
<li>PIXI.TextureCache has been removed. It was only ever used by the <strong>default and </strong>missing images that Phaser generates on start-up. It wasn't used internally by Phaser anywhere else, and the only references Pixi has to it have all been removed. If you need it in your own game, please refactor it to avoid it, or re-create the object on the PIXI global object.</li>
<li>Canvases created by <code>BaseTexture.fromCanvas</code> no longer have the <code>_pixiId</code> property attached to them, as this was never used internally by Phaser or Pixi.</li>
<li>PIXI.BaseTexture.updateSourceImage is now deprecated. Please use <code>Sprite.loadTexture</code> instead.</li>
<li>The property PIXI.BaseTextureCacheIdGenerator has been removed, as it is no longer used internally by Phaser or Pixi.</li>
<li>PIXI.Texture.addTextureToCache has been removed. The PIXI Texture Cache was never actually used by Phaser, and was leading to complications internally.</li>
<li>PIXI.Texture.removeTextureFromCache has been removed. The PIXI Texture Cache was never actually used by Phaser, and was leading to complications internally.</li>
<li>PIXI.Texture.fromFrame and PIXI.Sprite.fromFrame have been removed. They relied on the PIXI Texture Cache, which was never actually used by Phaser, and was never used internally by Pixi either.</li>
<li>The property PIXI.TextureCacheIdGenerator has been removed, as it was not used internally.</li>
<li>The property PIXI.FrameCache has been removed, as it was not used internally.</li>
<li>PIXI.DisplayObjectContainer calls <code>updateTransform</code> at the start of <code>getBounds</code> to help avoid the bounds being out of date.</li>
</ul>
<p>Thanks to Corin Wilkins at Aardman Digital, for lots of the investigation work, leading to the Pixi changes listed above.</p>
...
<p><img src="http://phaser.io/images/github/div-contributing.png" alt="Contributing" title="Contributing">
